...
class TestExpressionsApi:
    def test_expressions_api(self, app, users, campaign_scopes):
    ...
    def test_expressions_as_user_api(self, app, users, campaign_scopes, expressions):
