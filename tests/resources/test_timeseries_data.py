...
class TestTimeseriesDataApi:
    ...
    def test_timeseries_data_get_unknown_campaign(
        self,
        app,
        users,
        timeseries,
    ...
    def test_timeseries_data_get_aggregate_unknown_campaign(
        self,
        app,
        users,
        timeseries,
    ...
    def test_timeseries_data_post_unknown_campaign(self, app, users, timeseries):
