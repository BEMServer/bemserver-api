...
class TestTimeseriesEventsApi:
    ...
    def test_timeseries_events_api(
        ...
        c1_tse_url = (
            f"{CAMPAIGNS_URL}{campaign_1_id}{TIMESERIES_EVENTS_SUB_URL}")
        ...
        with AuthHeader(creds):
            ...
            ret = client.get(
                c1_tse_url,
                query_string={"channel_id": ec_1_id}
            )
            assert ret.status_code == 200
            ret_val = ret.json
            assert len(ret_val) == 1
    ...
    def test_timeseries_events_as_user_api(
        self, app, users,
        event_channels, campaigns, timeseries_events_by_campaigns
    ):
        ...
        c1_tse_url = (
            f"{CAMPAIGNS_URL}{campaign_1_id}{TIMESERIES_EVENTS_SUB_URL}")
        c2_tse_url = (
            f"{CAMPAIGNS_URL}{campaign_2_id}{TIMESERIES_EVENTS_SUB_URL}")
