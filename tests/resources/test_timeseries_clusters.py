...
class TestTimeseriesClusterApi:
    def test_timeseries_clusters_api(self, app, users, timeseries_cluster_groups):
        ...
        with AuthHeader(creds):
            ...
            # GET list
            ret = client.get(TIMESERIES_CLUSTERS_URL)
            ...
            ret = client.post(TIMESERIES_CLUSTERS_URL, json=timeseries_1)
            ...
            # GET by id
            ret = client.get(f"{TIMESERIES_CLUSTERS_URL}{timeseries_1_id}")
            assert ret.status_code == 200
            ...
            ret = client.put(
                f"{TIMESERIES_CLUSTERS_URL}{timeseries_1_id}",
                json=timeseries_1,
            ...
            # PUT wrong ID -> 404
            ret = client.put(
                f"{TIMESERIES_CLUSTERS_URL}{DUMMY_ID}",
                json=timeseries_1,
                headers={"If-Match": timeseries_1_etag},
            )
            ...
            ret = client.post(TIMESERIES_CLUSTERS_URL, json=timeseries_2)
            ret_val = ret.json
            ...
            ret = client.put(
                f"{TIMESERIES_CLUSTERS_URL}{timeseries_2_id}",
                json=timeseries_2,
    ...
    def test_timeseries_clusters_as_user_api(
        ...
        with AuthHeader(creds):
            ...
            ret_val = ret.json
            assert len(ret_val) == 1
            assert ret_val[0]["group_id"] == tscg_1
            ...
            ret = client.get(f"{TIMESERIES_CLUSTERS_URL}{timeseries_2_id}")
            assert ret.status_code == 403
    ...
    def test_timeseries_clusters_as_anonym_api(
        self, app, users, timeseries, timeseries_cluster_groups
    ):
