...
class TestEventBySiteApi:
    def test_events_by_sites_api(self, app, users, sites, events):
        ...
        with AuthHeader(creds):
            ...
            # PUT
            ebs_1["site_id"] = site_1_id
            ret = client.put(
                f"{EVENTS_BY_SITES_URL}{ebs_1_id}",
                json=ebs_1,
            ...
            # PUT event + site from different campaigns
            ebs_1["site_id"] = site_2_id
            ret = client.put(
                f"{EVENTS_BY_SITES_URL}{ebs_1_id}",
                json=ebs_1,
                headers={"If-Match": ebs_1_etag},
            ...
            assert ret.status_code == 404
            ret = client.delete(
                f"{EVENTS_BY_SITES_URL}{ebs_2_id}",
    ...
    def test_events_by_sites_as_user_api(
        ...
        with AuthHeader(user_creds):
            ...
            # PUT
            ebs_3["site_id"] = site_1_id
            ret = client.put(
                f"{EVENTS_BY_SITES_URL}{ebs_3_id}",
                json=ebs_3,
